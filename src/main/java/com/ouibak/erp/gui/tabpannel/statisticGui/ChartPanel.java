...
////        setBackground(Color.WHITE); // Set to white or any other "empty" color
////    }
////
...
////            // Display "no data" message or leave blank
////            return;
////        }
////        drawLineChart(g, salesData, Color.BLUE);
////        drawLineChart(g, orderData, Color.RED);
////    }
////
////    private void drawLineChart(Graphics g, List<Integer> data, Color color) {
...
////            int y1 = height + padding - data.get(i) * height / 30; // Normalize data
////            int x2 = padding + (i + 1) * pointWidth;
////            int y2 = height + padding - data.get(i + 1) * height / 30;
...
//    }
//
//    public void updateData(List<Integer> salesData, List<Integer> orderData, int maxData) {
//        this.salesData = salesData;
//        this.orderData = orderData;
//        this.maxData = Math.max(7, maxData) + 3;
//        repaint();
//    }
//
//    @Override
...
//        if (salesData != null && orderData != null) {
//            drawAxes(g);
//            drawLineChart(g, salesData, Color.BLUE, "Sales");
//            drawLineChart(g, orderData, Color.RED, "Orders");
//        }
//    }
//
...
////        int maxData = 10; // Adjust maxData based on your data set scale
...
//        int previousY = height + padding - (data.get(0) * height / 10);  // Adjust scaling accordingly
//        for (int i = 1; i < data.size(); i++) {
//            int x = padding + i * pointWidth;
//            int y = height + padding - (data.get(i) * height / 10);  // Adjust scaling accordingly
