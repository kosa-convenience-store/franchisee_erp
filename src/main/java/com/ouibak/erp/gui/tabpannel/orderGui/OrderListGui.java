...
public class OrderListGui {
    ...
    public void updateTableData() {
        SwingWorker<Void, OrderListDto> worker = new SwingWorker<>() {
            @Override
            protected Void doInBackground() {

                List<OrderListDto> orders = controller.getRecentOrderPaging(currentPage, pageSize, Cookie.getFranchiseeIdx());
            ...
            @Override
            protected void process(List<OrderListDto> chunks) {
                for (OrderListDto order : chunks) {
    ...
    private void showOrderDetails(int orderIdx) {
        List<OrderDetailDto> orderDetails = controller.getOrderDetails(orderIdx);
